...
loadGame={
	preload:function(){
    game.load.audio('ouch',"audio/ouch.mp3")
	game.load.audio('sound',"audio/Patintero.mp3")
    game.load.image('anim','img/patintero.jpg');
    game.load.image('bg','img/base1.png');
    game.load.image('star','img/star.png');
    game.load.spritesheet('naruto','img/charniel.png',64,64);
    game.load.spritesheet('naruto1','img/charniel.png',64,64);
    ...
    game.load.image('border','img/c.png'); 
    game.load.image('border1','img/f.png'); 
    game.load.image('x','img/x1.png');
    game.load.image('y','img/x1.png');
},
create:function(){
